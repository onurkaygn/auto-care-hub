...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("carApp.Entities.Arac", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("carApp.Entities.Kullanici", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("carApp.Entities.Marka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("carApp.Entities.Musteri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("carApp.Entities.Rol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("carApp.Entities.Satis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("carApp.Entities.Servis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("carApp.Entities.Arac", b =>
                {
                    b.HasOne("carApp.Entities.Marka", "Marka")
                        .WithMany()
            ...
            modelBuilder.Entity("carApp.Entities.Kullanici", b =>
                {
                    b.HasOne("carApp.Entities.Rol", "Rol")
                        .WithMany()
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("carApp.Entities.Musteri", b =>
                {
                    b.HasOne("carApp.Entities.Arac", "Arac")
                        .WithMany()
            ...
            modelBuilder.Entity("carApp.Entities.Satis", b =>
                {
                    ...
                    b.HasOne("carApp.Entities.Musteri", "Musteri")
                        .WithMany()
